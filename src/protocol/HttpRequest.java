...
public abstract class HttpRequest implements IHttpRequest {
	 ...
	 */
	public static IHttpRequest read(InputStream inputStream, Server server) throws Exception {
		...
		HashMap<String,Constructor<?>> requests = server.getRequests();
		String method = tokenizer.nextToken();
		HttpRequest request = (HttpRequest) requests.get(method).newInstance();
